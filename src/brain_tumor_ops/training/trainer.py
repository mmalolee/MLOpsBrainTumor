...
class Trainer:
    ...
    def _save_model(
        ...
        model_timestamp = str(datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))  # noqa: DTZ005
        model_path = artifacts_dir / model_timestamp
    ...
    def fit(
        ...
        self._save_model(artifacts_dir, model, optimizer, avg_loss)
